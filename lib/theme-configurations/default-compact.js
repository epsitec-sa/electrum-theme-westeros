...
const Colors = require('../themes/colors/default-colors.js');
const Spacing = require('../themes/spacings/compact-spacing.js');
const Timing = require('../themes/timings/default-timing.js');
const Look = require('../themes/looks/default-look.js');
