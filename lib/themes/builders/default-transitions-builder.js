...
module.exports = function(timings) {
  const transitions = {
    ...
    retroOpenTransition: '0.8s ease-out',
    retroOpenFunction: 'cubic-bezier(0.27, 2.0, 0.2, 1.0)',
    retroCloseTransition: '0.7s ease-out',
    retroCloseFunction: 'cubic-bezier(0.9, -0.7, 0.85, 0.4)',
  };
