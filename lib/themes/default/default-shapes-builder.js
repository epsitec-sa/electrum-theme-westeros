...
module.exports = function(spacing) {
  return {
    ...
    secondaryActionPadding: multiply(spacing.lineHeight, 0.3),
    secondaryActionSpacing: multiply(spacing.lineHeight, 0.2),
    ...
    treePadding: multiply(spacing.lineSpacing, 0.8),
