...
export default function (colors) {
  return {
    ...
    hintTextColor: lighten (colors.dark, 0.8),
    ...
    taskBackground: darken (colors.base, 0.1),
    taskLogoBackground: colors.light,
    taskButtonBorder: darken (colors.base, 0.3),
    taskButtonBackground: darken (colors.base, 0.0),
    taskSeparatorBackground: darken (colors.base, 0.15),
    ...
    paneHeaderBackground: lighten (colors.dark, 0.7),
    ...
    textFieldRequiredBackground: lighten (colors.alert, 0.8),
    ...
    calendarActiveSubBackground: lighten (colors.warning, 0.3),
    ...
    flyingBalloonWarningBackground: darken (colors.alert, 0.1),
    ...
    ticketHilitedBackground: lighten (colors.base, 0.7),
    ...
    tableSuccessBackground: lighten (colors.success, 0.5),
    tableWarningBackground: lighten (colors.warning, 0.5),
    ...
    dynamicToolbarBackground: lighten (colors.dark, 0.1),
    dynamicToolbarButtonGlyph: darken (colors.light, 0.4),

    toolbarInactiveBackground: lighten (colors.dark, 0.1),
    toolbarInactiveText: lighten (colors.dark, 0.7),
    toolbarActiveBackground: colors.light,
    toolbarActiveText: darken (colors.light, 0.7),

    focused: fade (colors.base, 0.5),
    checkButtonTextHover: lighten (colors.base, 0.2),

    pluginToolbarEditBackground: colors.base,
    pluginToolbarReadonlyBackground: darken (colors.light, 0.2),
    pluginLightButtonGlyph: lighten (colors.dark, 0.2),
    pluginLightButtonGlyphHover: colors.light,
    pluginLightButtonBackgroundHover: 'rgba(0, 0, 0, 0.15)',
    pluginDarkButtonGlyph: darken (colors.light, 0.1),
