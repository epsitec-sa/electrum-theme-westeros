...
export default function(colors) {
  return {
    ...
    hintTextColor: _lighten(colors, colors.dark, colors.isDarkTheme ? 0.6 : 0.8),

    rootBackground: _darken(colors, colors.base, colors.isDarkTheme ? 0.2 : 0.4),

    taskBackground: _darken(colors, colors.base, colors.isDarkTheme ? 0.05 : 0.1),
    ...
    viewTabBackground: _lighten(colors, colors.dark, colors.isDarkTheme ? 0.2 : 0.0),
    ...
    footerBackground: _lighten(colors, colors.dark, colors.isDarkTheme ? 0.2 : 0.0),
    ...
    paneHeaderBackground: _lighten(colors, colors.dark, colors.isDarkTheme ? 0.55 : 0.7),
    ...
    textFieldBackground: colors.light,
    ...
    calendarDimmedText: _lighten(colors, colors.dark, colors.isDarkTheme ? 0.5 : 0.8),
    ...
    chronoNavigatorBackground: _darken(colors, colors.base, colors.isDarkTheme ? 0.6 : 0.4),
    ...
    chronoLabelTooltipBackground: lighten(colors.base, colors.isDarkTheme ? 0.1 : 0.7),
    ...
    flyingDialogBackground: colors.isDarkTheme ? lighten(colors.light, 0.25) : colors.light,
    flyingDialogFullScreenBackground: colors.isDarkTheme ? 'rgba(0, 0, 0, 0.5)' : 'rgba(0, 0, 0, 0.2)',
    ...
    ticketShadow: colors.isDarkTheme ? darken(colors.light, 0.9) : emphasize(colors.light, 0.2),
    ...
    ticketGlueBackground: _darken(colors, colors.light, colors.isDarkTheme ? 0.15 : 0.1),
    ticketGlueHilitedBackground: lighten(colors.base, 0.5),
    ticketMessengerBackground: _lighten(colors, colors.base, 0.5),
    ticketMessengerHilitedBackground: colors.isDarkTheme ? lighten(colors.base, 0.3) : colors.base,
    ...
    ticketHilitedBackground: lighten(colors.base, colors.isDarkTheme ? 0.2 : 0.5),
    ...
    ticketNumberBackground: colors.isDarkTheme ? 'rgba(255, 255, 255, 0.2)' : 'rgba(0, 0, 0, 0.1)',
    ticketSubpaneBorder: _darken(colors, colors.light, 0.3),
    ticketGaugeBackground: _darken(colors, colors.light, 0.5),
    ticketGaugeBackgroundShadow: 'inset 3px 1px 6px ' + _darken(colors, colors.light, 0.75),
    ...
    dragAndDropShadow: colors.isDarkTheme ? '0px 10px 50px rgba(0, 0, 0, 0.80)' : '0px 10px 50px rgba(0, 0, 0, 0.50)',
    ...
    treeExpandButtonHover: colors.isDarkTheme ? colors.hilite : lighten(colors.base, 0.5),
    ...
    pluginDarkButtonGlyph: _darken(colors, colors.light, colors.isDarkTheme ? 0.5 : 0.1),
    ...
    markdownHiliteText: _lighten(colors, colors.dark, colors.isDarkTheme ? 0.0 : 0.2),
    markdownHiliteBackground: colors.isDarkTheme ? lighten(colors.base, 0.3) : lighten(colors.base, 0.8),

    tooltipBackground: colors.tooltip,
    tooltipBorder: _lighten(colors, colors.dark, 0.4),
    tooltipText: _darken(colors, colors.dark, 0.5),

    boardSampleText: _lighten(colors, colors.dark, 1.0),
    boardSampleBacklog: lighten(colors.success, 0.4),
    boardSampleRoadbooks: lighten(colors.base, 0.4),
    boardSampleDesks: lighten(colors.warning, 0.1),
  };
}
