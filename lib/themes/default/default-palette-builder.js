...
module.exports = function(colors) {
  return {
    ...
    documentExecutedBackground: colors.light,
    documentExecutedBackgroundHover: _lighten(colors, colors.base, 0.85),
    documentPlannedBackground1: colors.light,
    documentPlannedBackground2: _darken(colors, colors.light, 0.025),
    documentPlannedBackgroundHover1: _lighten(colors, colors.base, 0.85),
    documentPlannedBackgroundHover2: _darken(
      colors,
      _lighten(colors, colors.base, 0.85),
      0.025
    ),
    ...
    tableFilterHeaderHatch: colors.isDarkTheme
      ...
      : fade(colors.dark, 0.1),
    tableFilterCellBackground: colors.isDarkTheme
      ? fade(colors.dark, 0.3)
      : fade(colors.base, 0.2),
    ...
    markdownHiliteText: _lighten(
      colors,
      colors.dark,
      colors.isDarkTheme ? 0.0 : 0.2
    ),
    markdownHiliteBackground: colors.isDarkTheme
      ? lighten(colors.base, 0.3)
      : lighten(colors.base, 0.8),
